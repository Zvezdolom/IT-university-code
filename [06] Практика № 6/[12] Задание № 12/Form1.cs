...
namespace _12__Задание___12
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            GeometricMean = Math.Pow(GeometricMean, ((double)1.0 / (double)Array.Length));

            label5.Text += "Cреднее арифметическое: " + Math.Round(ArithmeticMean, 5).ToString() + "\n";
            label5.Text += "Cреднее геометрическое: " + Math.Round(GeometricMean, 5).ToString();
